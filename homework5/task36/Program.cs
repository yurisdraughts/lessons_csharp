...
//зададим метод, подсчитывающий сумму эл-тов на чётных позициях
...
//зададим метод, выводящий на консоль введённый массив и сумму эл-тов на чётных позициях
void PrintResult(int[] array)
{
    Console.WriteLine($"{StringifyArray(array)} -> {SumEven(array)}.");
}

//вызовем пару методов, создающую случайный массив и выводящую сумму эл-тов на чётных позициях
